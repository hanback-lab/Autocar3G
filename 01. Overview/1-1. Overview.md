...
AutoCar G(이하 AutoCar)는 사용자의 직접 제어 없이, 엣지 디바이스를 메인 프로세서로 활용하여 자율주행 기능을 수행하도록 설계된 교육·연구용 플랫폼입니다. 엣지 디바이스는 Nvidia Jetson 기반의 AI 모듈이 탑재되어 있어 영상처리·센서융합·딥러닝 기반 모델 실행 등 다양한 인공지능 기능을 안정적으로 구현할 수 있습니다.
