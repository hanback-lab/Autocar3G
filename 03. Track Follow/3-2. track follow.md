...
> [!Important]
> 아래 프로그램은 PC에서 원격으로 실행합니다. PC의 product 파일 정보를 자신의 작업 공간에 생상하고, product 파일의 정보는 Chapter 02 내용을 참고하여 작성하되, BROKER_DOMAIN과 CAMERA_DOMAIN은 AutoCar의 유/무선 IP를 입력합니다.
>
> ```sh
> 작성 예시)
...
> ```
>
> PC 환경에서 IP를 잘못 입력할 경우 카메라 데이터를 받을 수 없으니 입력에 유의하시길 바랍니다.
